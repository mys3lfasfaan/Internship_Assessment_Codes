...
data = pd.read_excel('D:\ProCoding\Internship INTERNSHALA\Output.xlsx')
...
for i, j in zip(url_id, url):
    ...
    try:
        ...
        complex_words = [word for word in filtered_words if (syllables(word)) >= 3]
